...
const HomeSocialLinks = ({data, index}) => {
  ...
  return (
    ...
    className="w-12 h-12 rounded-full bg-gradient-to-br from-primary to-secondary relative
    ...
    >
      ...
      <AnimatePresence>
    {isHovered && (
      <motion.div className={`absolute inset-0 blur-md bg-gradient-to-br from-primary
      to-secondary -z-10`}>
     </motion.div>
    )}
