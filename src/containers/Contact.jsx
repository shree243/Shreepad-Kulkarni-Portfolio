      ...
      <div className="w-full flex flex-col items-center justify-start gap-4">
        ...
        bg-transparent focus:border-primary outline-none  text-white"/>
          ...
          <div className="w-full flex items-center justify-center lg:justify-end">
            ...
            <button className="px-12 py-3 bg-gradient-to-br from-primary
             to-secondary rounded-md w-full lg:w-auto hover:bg-gradient-to-br hover:from black hover:to-black
